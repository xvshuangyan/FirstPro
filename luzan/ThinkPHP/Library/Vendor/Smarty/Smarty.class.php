...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    */
    ...
    /**
     * allow ambiguous resources (that are made unique by the public handler)
     * @var boolean
     */
    ...
    */
    ...
    /**
    * controls if the php template file public is allowed
    *
    * @var bool
    */
    ...
    */
    ...
    /**
    * public type used if none given
    *
    ...
    */
    ...
    /**
    * Check if a template public exists
    *
    ...
    * @param string  $type     public type
    * @return integer number of cache files deleted
    */
    function clearAllCache($exp_time = null, $type = null)
    {
        // load cache public and call clearAll
    ...
    */
    ...
    {
        // load cache public and call clear
        $_cache_resource = Smarty_CacheResource::load($this, $type);
        Smarty_CacheResource::invalidLoadedCache($this);
    ...
    *
    * @param string $template the public handle of the template file
