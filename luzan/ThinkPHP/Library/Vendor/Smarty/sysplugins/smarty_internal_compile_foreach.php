...
class Smarty_Internal_Compile_Foreach extends Smarty_Internal_CompileBase {
    ...
    public function compile($args, $compiler, $parameter)
    {
        ...
        if ($has_name) {
            ...
            $usesSmartyShow = strpos($tpl->source->content, $SmartyVarName . 'home') !== false;
        ...
        $usesPropShow = strpos($tpl->source->content, $ItemVarName . 'home') !== false;
        ...
        if ($usesPropShow) {
            $output .= " \$_smarty_tpl->tpl_vars[$item]->home = (\$_smarty_tpl->tpl_vars[$item]->total > 0);\n";
        }
        if ($has_name) {
            if ($usesSmartyTotal) {
            ...
            if ($usesSmartyShow) {
                $output .= " \$_smarty_tpl->tpl_vars['smarty']->value['foreach'][$name]['home']=(\$_smarty_tpl->tpl_vars[$item]->total > 0);\n";
            }
        }
