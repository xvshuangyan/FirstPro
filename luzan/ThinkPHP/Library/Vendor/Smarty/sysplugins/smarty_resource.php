 ...
 * Smarty Resource Plugin
 *
 * Base implementation for public plugins
 *
 * @package Smarty
 * @subpackage TemplateResources
 */
abstract class Smarty_Resource {
    ...
    /**
     * public types provided by the core
     * @var array
     */
    ...
    /**
     * Name of the Class to compile this public's contents with
     * @var string
     */
    public $compiler_class = 'Smarty_Internal_SmartyTemplateCompiler';

    /**
     * Name of the Class to tokenize this public's contents with
     * @var string
     */
    public $template_lexer_class = 'Smarty_Internal_Templatelexer';

    /**
     * Name of the Class to parse this public's contents with
     * @var string
     */
    ...
    /**
     * modify resource_name according to public handlers specifications
     *
     * @param Smarty $smarty        Smarty instance
     * @param string $resource_name resource_name to make unique
     * @return string unique public name
     */
    ...
    protected function buildFilepath(Smarty_Template_Source $source, Smarty_Internal_Template $_template=null)
    {
        ...
        if ($_template && $_template->parent instanceof Smarty_Internal_Template && $_file_is_dotted) {
            if ($_template->parent->source->type != 'file' && $_template->parent->source->type != 'extends' && !$_template->parent->allow_relative_path) {
                throw new SmartyException("Template '{$file}' cannot be relative to template of public type '{$_template->parent->source->type}'");
            }
     ...
     *
     * @param Smarty_Template_Source $source source object
     * @return string public's basename
     */
     ...
     * @param string $type      name of the public
    ...
    public static function load(Smarty $smarty, $type)
    {
        ...
        if ($smarty->loadPlugin($_resource_class)) {
            ...
            if (class_exists($_resource_class, false)) {
                ...
                // give it another try, now that the public is registered properly
        ...
        // give up
        throw new SmartyException("Unkown public type '{$type}'");
    }
    
    /**
     * extract resource_type and resource_name from template_resource and config_resource
     *
     * @note "C:/foo.tpl" was forced to file public up till Smarty 3.1.3 (including).
     * @param string  $resource_name    template_resource or config_resource to parse
     * @param string  $default_resource the default resource_type defined in $smarty
     * @param string &$name             the parsed public name
     * @param string &$type             the parsed public type
     * @return void
     */
    protected static function parseResourceName($resource_name, $default_resource, &$name, &$type)
    {
        ...
        if (!isset($parts[1]) || !isset($parts[0][1])) {
            // no public given, use default
            // or single character before the colon is not a public type, but part of the filepath
    ...
    /**
     * modify template_resource according to public handlers specifications
     *
     * @param string $smarty            Smarty instance 
     * @param string $template_resource template_resource to extracate public handler and name of
     * @return string unique public name
     */
    public static function getUniqueTemplateName($smarty, $template_resource)
    {
        ...
        // TODO: optimize for Smarty's internal public types
        $resource = Smarty_Resource::load($smarty, $type);
        return $resource->buildUniqueResourceName($smarty, $name);
    }
    
    /**
     * initialize Source Object for given public
     *
     * Either [$_template] or [$smarty, $template_resource] must be specified
     *
     * @param Smarty_Internal_Template $_template         template object
     * @param Smarty                   $smarty            smarty object
     * @param string                   $template_resource public identifier
    ...
    public static function source(Smarty_Internal_Template $_template=null, Smarty $smarty=null, $template_resource=null)
    {
        ...
        // parse resource_name, load public handler, identify unique public name
        self::parseResourceName($template_resource, $smarty->default_resource_type, $name, $type);
        $resource = Smarty_Resource::load($smarty, $type);
    ...
    /**
     * initialize Config Source Object for given public
     *
    ...
    public static function config(Smarty_Internal_Config $_config)
    {
        ...
        if (isset($_incompatible_resources[$type])) {
            throw new SmartyException ("Unable to use public '{$type}' for config");
        }

        // load public handler, identify unique public name
        $resource = Smarty_Resource::load($smarty, $type);
        $unique_resource_name = $resource->buildUniqueResourceName($smarty, $name);
...
class Smarty_Template_Source {
     ...
     * @param string          $type             type of public
     * @param string          $name             public name
     * @param string          $unique_resource  unqiue public name
     */
