...
* Smarty Internal Plugin Resource Extends
*
* Implements the file system as public for Smarty which {extend}s a chain of template files templates
*
* @package Smarty
* @subpackage TemplateResources
*/
    ...
    */
    public function populate(Smarty_Template_Source $source, Smarty_Internal_Template $_template=null)
    {
        ...
        foreach ($components as $component) {
            ...
            if ($s->type == 'php') {
                throw new SmartyException("Resource type {$s->type} cannot be used with the extends public type");
            }
            $sources[$s->uid] = $s;
            $uid .= $s->filepath;
