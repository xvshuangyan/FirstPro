...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data {
     ...
     *
     * @param string $template          the public handle of the template file or template object
     ...
     *
     * @param string|object $template   the public handle of the template file or template object
     * @param mixed         $cache_id   cache id to be used with this template
     * @param mixed         $compile_id compile id to be used with this template
     * @param object        $parent     next higher level of Smarty variables
    ...
    /**
     * Registers a public to fetch a template
     *
     * @param string $type name of public type
     * @param Smarty_Resource|array $callback or instance of Smarty_Resource, or array of callbacks to handle public (deprecated)
     */
    ...
    /**
     * Registers a cache public to cache a template's output
     *
     * @param string               $type     name of cache public type
