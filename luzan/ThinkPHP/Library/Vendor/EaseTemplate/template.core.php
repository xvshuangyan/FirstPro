	...
	*/
	function inc_list(){
		if(is_array($this->IncList)){
			...
			$sf13    = ' style="fonts-size:13px;color:#666666"';
			echo '<br><table border="1" width="100%" cellpadding="3" style="border-collapse: collapse" bordercolor="#DCDCDC">
<tr bgcolor="#B5BDC1"><td><fonts color=#000000 style="fonts-size:16px;"><b>Include Templates (Num:'.count($this-> IncList).')</b></fonts></td>
<td align="right">';

if($this->RunType=='Cache'){
	echo '[<a onclick="alert(\'Cache file is successfully deleted\');location=\''.$clear_link.'\';return false;" href="'.$clear_link.'"><fonts'.$sf13.'>Clear Cache</fonts></a>]';
}
