            ...
            <div class="articleList">
                <?php if(is_array($perPageList)): foreach($perPageList as $key=>$vo): ?><div class="row">
                        ...
                        <div class="col-lg-9 thumbContent">
                            ...
                            <p class="btm-message"><span class="small_title"><?php echo ($vo['small_title']); ?></span><span class="update_time"><?php echo (date("Y-m-d H:i:s",$vo['update_time'])); ?></span><span class="readCount">阅读(<?php echo ($vo['count']); ?>)</span></p>
                        </div>
