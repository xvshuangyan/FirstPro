...
;(function()
{
	...
	function Brush()
	{
		...
		var values =	'above absolute all always aqua armenian attr aural auto avoid baseline behind below bidi-override black blink block blue bold bolder '+
						...
						'rightwards rtl run-in screen scroll semi-condensed semi-expanded separate se-resize home silent silver slower slow '+
...
;(function()
{
	...
	function Brush()
	{
		...
		var verbs =		'write where wait use update unregister undo trace test tee take suspend ' +
						'stop start split sort skip home set send select scroll resume restore ' +
